...
object linearization1 {
	...
	};import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(587); 
	
	// m을 호출시 트레이트의 선언이 오른쪽에서 왼쪽으로 선언됨을 볼 수 있다.
	val c2 = new C2;System.out.println("""c2  : proscala.chap11.linearization1.C2 = """ + $show(c2 ));$skip(6); 
	c2.m;$skip(13); 
	println("")}
}
