...
object override_payroll_template_method {
	...
	};import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(1152); 
	
	val tom = Employee("Tom Jones", 100000.0, Address("MyTown", "XX", "123456"));System.out.println("""tom  : proscala.chap11.override_payroll_template_method.Employee = """ + $show(tom ));$skip(79); 
	val jane  = Employee("Jane Doe", 110000.0, Address("BigCity", "YY", "67890"));System.out.println("""jane  : proscala.chap11.override_payroll_template_method.Employee = """ + $show(jane ));$skip(27); val res$0 = 
	
	Payroll2014.netPay(tom);System.out.println("""res0: Double = """ + $show(res$0));$skip(26); val res$1 = 
	Payroll2014.netPay(jane);System.out.println("""res1: Double = """ + $show(res$1))}
