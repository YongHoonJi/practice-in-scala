...
object vetoable_clicks_uap {
	...
	val obsbutton =
		...
		}                                 //> obsbutton  : proscala.chap11.vetoable_clicks_uap.Button4 with proscala.chap
                                                  //| 11.vetoable_clicks_uap.ObservableClicks with proscala.chap11.vetoable_click
                                                  //| s_uap.VetoableClicksUAP{val maxAllowed: Int} = proscala.chap11.vetoable_cli
                                                  //| cks_uap$$anonfun$main$1$$anon$1@dcf3e99
		
	
	val bco3 = new ClickCountObserver         //> bco3  : proscala.chap11.vetoable_clicks_uap.ClickCountObserver = proscala.c
                                                  //| hap11.vetoable_clicks_uap$ClickCountObserver@340f438e
	val bco4 = new ClickCountObserver         //> bco4  : proscala.chap11.vetoable_clicks_uap.ClickCountObserver = proscala.c
                                                  //| hap11.vetoable_clicks_uap$ClickCountObserver@30c7da1e
	obsbutton addObserver bco3
	obsbutton addObserver bco4
	obsbutton.click()                         //> update ui
